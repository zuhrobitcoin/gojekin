    ...
    if ($verif == false)
        ...
        if ($claim == false)
            ...
            if ($claim == false) {
                echo "\e[92m[!]".$claim['errors'][0]['message']."\n";
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOFOODSANTAI15 !\n";
                sleep(3);
                goto ride;
            }
          else
            ...
            echo "\e[92m[+] ".$claim . "\n";
            sleep(3);
            echo "\e[93m[!] Trying to redeem Voucher : GOFOODSANTAI18 !\n";
            sleep(3);
            goto ride;
            }
            ride:
            ...
            if ($claim == false ) {
                echo "\e[92m[!]".$claim['errors'][0]['message']."\n";
                sleep(3);
                echo "\e[93m[!] Trying to redeem Voucher : GOFOODSANTAI 19!\n";
                sleep(3);
